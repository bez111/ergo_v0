    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="space-y-8">
        ...
        <div className="bg-purple-400/10 border border-purple-400/20 rounded-xl p-6">
          ...
          <CodeBlock language="typescript">`# Assign the node URL
node_url: str = "http://213.239.193.208:9052/"

# Establish the connection
ergo = appkit.ErgoAppKit(node_url=node_url)`</CodeBlock>
        </div>
        ...
        <div className="bg-pink-400/10 border border-pink-400/20 rounded-xl p-6">
          ...
          <CodeBlock language="typescript">`# Define the wallet mnemonic
...
genesis_receiver = [""]`</CodeBlock>
        ...
        <div className="bg-cyan-400/10 border border-cyan-400/20 rounded-xl p-6">
          ...
          <CodeBlock language="typescript">`# Generate a signed transaction
...
genesis_outbox = appkit.get_outputs_to_spend(genesis_tx, 0)`</CodeBlock>
        </div>
        ...
        <div className="bg-purple-400/10 border border-purple-400/20 rounded-xl p-6">
          ...
          <CodeBlock language="typescript">`# Print the transaction ID of the genesis transaction
