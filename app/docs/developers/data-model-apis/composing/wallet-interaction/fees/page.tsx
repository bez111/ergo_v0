    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="space-y-8">
        ...
        <div className="bg-orange-400/10 border border-orange-400/20 rounded-xl p-6">
          ...
          <CodeBlock language="typescript">`# Mempool transaction sorting scheme ("random", "bySize", or "byExecutionCost")
...
def feeProposition(delta: Int = 720): ErgoTree = {
  ...
  AND(
    ...
    EQ(SizeOf(Outputs), 1)
          ...
          <CodeBlock language="typescript">`private def extractFee(tx: ErgoTransaction): Long = {
  tx.outputs
