    ...
    <>
      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          <CodeBlock language="typescript" children={bash6} />
        </div>
        ...
        <div>
          ...
          <CodeBlock language="typescript" children={bash7} />
        ...
        <div>
          ...
          <CodeBlock language="typescript" children={bash8} />
        ...
        <div>
          ...
          <CodeBlock language="typescript" children={bash9} />
