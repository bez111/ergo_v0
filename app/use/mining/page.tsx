            ...
            <Tabs value={selectedTab} onValueChange={setSelectedTab} className="w-full">
              <div className="flex justify-center mb-12">
                <TabsList className="bg-neutral-900 border border-neutral-700 p-1">
                  <TabsTrigger value="overview" className="data-[state=active]:bg-brand-primary-500 data-[state=active]:text-black focus:ring-2 focus:ring-brand-primary-500 focus:ring-offset-2 focus:ring-offset-neutral-900 transition-all duration-200">
                    Overview
                </TabsTrigger>
                  <TabsTrigger
                  ...
                  <TabsTrigger value="hardware" className="data-[state=active]:bg-brand-primary-500 data-[state=active]:text-black focus:ring-2 focus:ring-brand-primary-500 focus:ring-offset-2 focus:ring-offset-neutral-900 transition-all duration-200">
                    Hardware
                  </TabsTrigger>
                  <TabsTrigger value="pools" className="data-[state=active]:bg-brand-primary-500 data-[state=active]:text-black focus:ring-2 focus:ring-brand-primary-500 focus:ring-offset-2 focus:ring-offset-neutral-900 transition-all duration-200">
                    Pools
                  </TabsTrigger>
                  <TabsTrigger
                    value="calculator"
              ...
              <TabsContent value="overview" className="space-y-8">
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  <Card className="bg-neutral-900/50 border border-neutral-700 rounded-xl p-8">
                    <h3 className="text-2xl font-bold mb-4 text-brand-primary-400">What is Ergo Mining?</h3>
                  ...
                  <Card className="bg-neutral-900/50 border border-neutral-700 rounded-xl p-8">
                    <h3 className="text-2xl font-bold mb-4 text-brand-primary-400">Why Mine Ergo?</h3>
                    <div className="space-y-4">
                      <div className="flex items-start gap-3">
                        <TrendingUp className="w-5 h-5 text-brand-primary-400 mt-1" />
                        <div>
                      ...
                      <div className="flex items-start gap-3">
                        <Shield className="w-5 h-5 text-brand-primary-400 mt-1" />
                        <div>
                      ...
                      <div className="flex items-start gap-3">
                        <Users className="w-5 h-5 text-brand-primary-400 mt-1" />
                        <div>
                      ...
                      <div className="flex items-start gap-3">
                        <Globe className="w-5 h-5 text-brand-primary-400 mt-1" />
                        <div>
                ...
                <Card className="bg-neutral-900/50 border border-neutral-700 rounded-xl p-8">
                  <h3 className="text-2xl font-bold mb-6 text-brand-primary-400">Profitability Factors</h3>
                  <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {profitabilityFactors.map((factor, index) => (
                      <div key={index} className="p-4 bg-neutral-900/50 rounded-lg border border-brand-primary-500/20">
              ...
              <TabsContent value="getting-started" className="space-y-8">
                  ...
                  {miningSteps.map((step, index) => (
                    <Card key={index} className="bg-neutral-900/50 border border-neutral-700 rounded-xl p-6">
                      <div className="flex items-center gap-6">
                        <div className="flex-shrink-0 w-12 h-12 bg-brand-primary-500/20 rounded-full flex items-center justify-center border border-brand-primary-500">
                          <span className="text-brand-primary-400 font-bold">{step.step}</span>
                        </div>
                        ...
                        <Button className="bg-brand-primary-500 hover:bg-brand-primary-500/80 text-black">{step.action}</Button>
                      </div>
                    </Card>
                  ))}
                </div>
                ...
                {/* Mining Software */}
                <Card className="bg-neutral-900/50 border border-neutral-700 rounded-xl p-8">
                  <h3 className="text-2xl font-bold mb-6 text-brand-primary-400">Recommended Mining Software</h3>
                  <div className="grid md:grid-cols-3 gap-6">
                    <div className="p-6 bg-neutral-900/50 rounded-lg border border-brand-primary-500/20">
              ...
              <TabsContent value="hardware" className="space-y-8">
                  ...
                  {hardwareRequirements.map((hw, index) => (
                    <Card key={index} className="bg-neutral-900/50 border border-neutral-700 rounded-xl p-8">
                      <div className="flex items-center gap-4 mb-6">
                        <div className="p-3 bg-brand-primary-500/20 rounded-lg border border-brand-primary-500">{hw.icon}</div>
                        <div>
                          <h3 className="text-2xl font-bold text-brand-primary-400">{hw.category}</h3>
                        ...
                        <div className="space-y-4">
                          <div className="p-4 bg-neutral-900/50 rounded-lg">
                            <div className="flex items-center gap-2 mb-2">
                              <Thermometer className="w-4 h-4 text-brand-primary-400" />
                ...
                {/* GPU Comparison */}
                <Card className="bg-neutral-900/50 border border-neutral-700 rounded-xl p-8">
                  <h3 className="text-2xl font-bold mb-6 text-brand-primary-400">GPU Performance Comparison</h3>
                  <div className="overflow-x-auto">
                    <table className="w-full text-sm">
                      <thead>
                        <tr className="border-b border-brand-primary-500/20">
                      ...
                      <tbody>
                        <tr className="border-b border-gray-800">
                          ...
                          <td className="p-3 text-brand-primary-400">250 MH/s</td>
                        ...
                        <tr className="border-b border-gray-800">
                          ...
                          <td className="p-3 text-brand-primary-400">200 MH/s</td>
                        ...
                        <tr className="border-b border-gray-800">
                          ...
                          <td className="p-3 text-brand-primary-400">160 MH/s</td>
                          <td className="p-3">320W</td>
                        ...
                        <tr className="border-b border-gray-800">
                          ...
                          <td className="p-3 text-brand-primary-400">140 MH/s</td>
              ...
              <TabsContent value="pools" className="space-y-8">
                ...
                <Alert className="border-brand-primary-500/20 bg-brand-primary-500/10">
                  ...
                  {miningPools.map((pool, index) => (
                    <Card key={index} className="bg-neutral-900/50 border border-neutral-700 rounded-xl p-6">
                      <div className="flex items-center justify-between mb-4">
                        <h3 className="text-xl font-bold text-brand-primary-400">{pool.name}</h3>
                      ...
                      <div className="space-y-3 mb-6">
                        ...
                        <div className="flex justify-between">
                          ...
                          <span className="text-brand-primary-400">{pool.fee}</span>
                        </div>
                        <div className="flex justify-between">
                      ...
                      <Button className="w-full bg-brand-primary-500 hover:bg-brand-primary-500/80 text-black">
                        <ExternalLink className="w-4 h-4 mr-2" />
                        Visit Pool
                      </Button>
                    </Card>
                ...
                <Card className="bg-neutral-900/50 border border-neutral-700 rounded-xl p-8">
                  <h3 className="text-2xl font-bold mb-6 text-brand-primary-400">Configuration Example</h3>
                  <div className="bg-neutral-900 p-6 rounded-lg border border-brand-primary-500/20">
                ...
                <Card className="bg-neutral-900/50 border border-neutral-700 rounded-xl p-8">
                  <div className="grid md:grid-cols-2 gap-8">
                    <div className="space-y-6">
                      <h3 className="text-xl font-bold text-brand-primary-400">Mining Parameters</h3>
                      ...
                      <div>
                        ...
                        <input
                          ...
                          className="w-full p-3 bg-neutral-900 border border-brand-primary-500/20 rounded-lg text-white"
                          placeholder="100"
                        />
                      </div>
                    ...
                    <div className="space-y-6">
                      <h3 className="text-xl font-bold text-brand-primary-400">Estimated Earnings</h3>
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="p-4 bg-brand-primary-500/20 rounded-lg border border-brand-primary-500">
                          <div className="flex justify-between items-center">
                            <span className="font-bold">Daily Profit:</span>
                            <span className="text-brand-primary-400 font-bold text-lg">
                              $
                              {(
              ...
              <TabsContent value="troubleshooting" className="space-y-8">
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  <Card className="bg-neutral-900/50 border border-neutral-700 rounded-xl p-6">
                    <h3 className="text-xl font-bold mb-4 text-brand-primary-400 flex items-center gap-2">
                ...
                {/* Security Tips */}
                <Card className="bg-neutral-900/50 border border-neutral-700 rounded-xl p-8">
                  <h3 className="text-2xl font-bold mb-6 text-brand-primary-400 flex items-center gap-2">
        ...
        <section className="py-16 px-4">
          <div className="max-w-4xl mx-auto text-center">
            <Card className="bg-neutral-900/50 border border-neutral-700 rounded-xl p-12">
              <h2 className="text-3xl font-bold mb-6 text-brand-primary-400">Ready to Start Mining?</h2>
              <p className="text-xl text-neutral-300 mb-8">
                Join thousands of miners securing the Ergo network and earning rewards
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button size="lg" className="bg-brand-primary-500 hover:bg-brand-primary-500/80 text-black">
