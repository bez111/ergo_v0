                ...
                <div>
                  ...
                  <nav aria-label="On this page" className="mt-6 text-sm text-neutral-400">
                    <ul className="flex flex-wrap gap-4">
                      <li><a href="#features" className="hover:text-brand-primary-400">Identity features</a></li>
            ...
            <div className="max-w-7xl mx-auto">
              ...
              <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
                <TabsList className="grid w-full grid-cols-3 bg-neutral-900/50 border border-neutral-700">
                  ...
                  <TabsTrigger value="reputation" className="data-[state=active]:bg-brand-primary-500 data-[state=active]:text-black">
                    Reputation
                  </TabsTrigger>
                    ...
                    <Card className="bg-neutral-900/50 border-neutral-700 backdrop-blur-sm">
                      ...
                      <CardContent>
                        <div className="grid md:grid-cols-2 gap-6">
                          <div>
                            <h4 className="font-semibold text-brand-primary-300 mb-3">Earning Reputation</h4>
                          ...
                          <div>
                            <h4 className="font-semibold text-brand-primary-300 mb-3">Using Reputation</h4>
                            <ul className="space-y-2 text-neutral-400 text-sm">
