                ...
                <div>
                  ...
                  <nav aria-label="On this page" className="mt-6 text-sm text-neutral-400">
                    <ul className="flex flex-wrap gap-4">
                      <li><a href="#features" className="hover:text-brand-primary-400">Oracle features</a></li>
                      <li><a href="#projects" className="hover:text-brand-primary-400">Live Oracles</a></li>
                    ...
                    <Card className="bg-neutral-900/50 border-neutral-700 backdrop-blur-sm">
                      ...
                      <CardContent>
                        <div className="grid md:grid-cols-2 gap-6">
                          <div>
                            <h4 className="font-semibold text-brand-primary-300 mb-3">Data Collection</h4>
                          ...
                          <div>
                            <h4 className="font-semibold text-brand-primary-300 mb-3">Aggregation</h4>
                            <ul className="space-y-2 text-neutral-400 text-sm">
