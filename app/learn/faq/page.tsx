...
const faqSections = [
  {
    ...
    questions: faqData.filter((q) => q.category === "general"),
  },
  {
    id: "technology",
    ...
    questions: faqData.filter((q) => q.category === "technology"),
  },
  {
    id: "economics",
    ...
    questions: faqData.filter((q) => q.category === "economics"),
  },
  {
    id: "ecosystem",
    ...
    questions: faqData.filter((q) => q.category === "ecosystem"),
  },
  {
    id: "wallets",
    ...
    questions: faqData.filter((q) => q.category === "wallets"),
  },
  {
    id: "troubleshooting",
    ...
    questions: faqData.filter((q) => q.category === "troubleshooting"),
  },
]
      ...
      <div className="relative z-10">
              ...
              <div className="text-center mb-16">
                ...
                <div className="max-w-4xl mx-auto mb-12">
                  ...
                  <p className="text-lg md:text-xl text-gray-400 leading-relaxed">
                    Deep dive into Ergo's technology, economics, and ecosystem. From basic concepts to advanced
                    technical details, find comprehensive answers to all your questions about the Ergo blockchain
                    platform.
                  </p>
                </div>
                              ...
                              {section.questions.map((question, questionIndex) => {
                                ...
                                return (
                                  ...
                                  >
                                    ...
                                    >
                                      <h4 className="text-lg font-medium text-white font-mono pr-4">
                                        {question.question}
                                      </h4>
                                      <motion.div
        ...
        <section className="py-20 px-4">
          <div className="max-w-5xl mx-auto">
            <SectionHeading text="NEED MORE INFORMATION?" />
