    ...
    <>
      ...
      <section className="mb-12">
        ...
        <div className="bg-neutral-900/60 border border-orange-500/30 rounded-xl p-6 mb-4">
          ...
          <ul className="list-disc pl-6 text-gray-300 space-y-2">
            <li>
              <strong>Memory-Hard:</strong> The algorithm is memory-intensive, meaning it requires significant RAM on your GPU. This design choice makes it difficult and expensive to develop specialized ASIC hardware, promoting decentralization.
            </li>
            <li>
              <strong>ASIC-Resistant:</strong> By being memory-hard, Autolykos v2 aims to prevent the dominance of large-scale ASIC farms, allowing individual GPU miners to remain competitive.
            </li>
            <li>
              <strong>GPU-Friendly:</strong> Optimized for general-purpose GPUs, making it accessible to a wide range of miners using consumer-grade hardware.
            </li>
            <li>
              <strong>Dynamic Difficulty:</strong> The network automatically adjusts the mining difficulty to maintain a consistent block time (approximately 2 minutes), ensuring a steady flow of new blocks.
            </li>
          </ul>
          <h3 className="font-semibold mt-6 mb-3 text-orange-400">Minimum Hardware Requirements:</h3>
          <ul className="list-disc pl-6 text-gray-300 space-y-2">
            <li>
              <strong>GPU:</strong> AMD RX 400/500/5000/6000/7000 series, NVIDIA GTX 10/RTX 20/30/40 series. <strong>Minimum 4 GB VRAM, 8 GB+ recommended</strong> for optimal performance and future-proofing.
            </li>
            <li>
              <strong>RAM:</strong> 8 GB or more system RAM.
            </li>
            <li>
              <strong>CPU:</strong> Modern Intel (i3/i5 equivalent or newer) or AMD (Ryzen 3/5 equivalent or newer).
            </li>
            <li>
              <strong>Storage:</strong> SSD (Solid State Drive) with at least 120 GB free space for the operating system and mining software. More space is needed if running a full Ergo node.
            </li>
            <li>
              <strong>Operating System:</strong> Linux (e.g., Ubuntu, HiveOS, RaveOS) is generally preferred for mining due to better performance and stability, but Windows is also supported.
            </li>
          </ul>
        </div>
      </section>
      ...
      <section className="mb-12">
        ...
        <div className="bg-neutral-900/60 border border-green-500/30 rounded-xl p-6 mb-4">
          ...
          <ul className="list-disc pl-6 text-gray-300 space-y-2">
            <li>
              <strong>Install Latest GPU Drivers:</strong> Always ensure you have the most recent stable drivers for your graphics cards. Outdated drivers can significantly impact performance.
            </li>
            <li>
              <strong>Increase Virtual Memory (Windows):</strong> On Windows, set your paging file (virtual memory) to at least 16 GB or more, especially if you have multiple GPUs. This is crucial for Autolykos v2's memory-hard nature.
            </li>
            <li>
              <strong>Linux Optimizations:</strong> For Linux-based mining rigs, consider using specialized mining operating systems like HiveOS or RaveOS, which come pre-configured with optimizations and mining software.
            </li>
          </ul>
          <h3 className="font-semibold mt-6 mb-3 text-green-400">GPU Overclocking & Undervolting:</h3>
          <ul className="list-disc pl-6 text-gray-300 space-y-2">
            <li>
              <strong>Memory Overclocking:</strong> Autolykos v2 is memory-intensive, so increasing your GPU's memory clock speed will directly improve your hashrate. Experiment with values to find stability.
            </li>
            <li>
              <strong>Core Clock & Power Limit Reduction:</strong> Reduce your GPU's core clock and power limit. This will lower power consumption and heat generation without significantly impacting Autolykos v2 performance, as it's less dependent on core clock.
            </li>
            <li>
              <strong>Tools:</strong> Use tools like MSI Afterburner (Windows) or command-line utilities (Linux) for precise control over your GPU settings.
            </li>
          </ul>
        </div>
      </section>
      ...
      <section className="mb-12">
        ...
        <div className="bg-neutral-900/60 border border-blue-500/30 rounded-xl p-6 mb-4">
          ...
          <ul className="list-disc pl-6 text-gray-300 space-y-1 mb-4">
            <li><strong>TeamRedMiner:</strong> (AMD GPUs)</li>
            <li><strong>Gminer:</strong> (NVIDIA/AMD GPUs)</li>
            <li><strong>NBminer:</strong> (NVIDIA/AMD GPUs)</li>
          </ul>
...
pause`}</code></pre>
      ...
      <section className="mb-12">
        ...
        <div className="bg-neutral-900/60 border border-purple-500/30 rounded-xl p-6 mb-4">
          ...
          <ul className="list-disc pl-6 text-gray-300 space-y-2">
            <li>
              <strong>Fully Synced Ergo Node:</strong> You must run your own full Ergo node with its RPC API enabled. Your miner will connect directly to your local node.
            </li>
            <li>
              <strong>Significant Hashrate:</strong> Solo mining is a lottery. Without a very high hashrate, finding a block can take a very long time (months or even years).
            </li>
          </ul>
      ...
      <section className="mb-12">
        ...
        <div className="bg-neutral-900/60 border border-cyan-500/30 rounded-xl p-6 mb-4">
          ...
          <ul className="list-disc pl-6 text-gray-300 space-y-2">
            <li>
              <strong>Online Calculators:</strong> Use websites like WhatToMine or dedicated pool profitability calculators to estimate your potential earnings based on your hashrate, power consumption, and current network conditions.
            </li>
            <li>
              <strong>Factors to Consider:</strong> Electricity costs, hardware efficiency, network difficulty, and ERG price fluctuations will all impact your profitability.
            </li>
          </ul>
          <h3 className="font-semibold mt-6 mb-3 text-cyan-400">Monitoring Your Mining Operation:</h3>
          <ul className="list-disc pl-6 text-gray-300 space-y-2">
            <li>
              <strong>Pool Dashboards:</strong> If you're pool mining, your chosen pool will provide a dashboard to monitor your hashrate, submitted shares, estimated earnings, and payout history.
            </li>
            <li>
              <strong>Mining Software Logs:</strong> Your mining software (e.g., Gminer, TeamRedMiner) will display real-time hashrate, temperature, power consumption, and any errors.
            </li>
            <li>
              <strong>GPU Monitoring Tools:</strong> Use tools specific to your GPU (e.g., GPU-Z, HWMonitor) to keep an eye on temperatures, fan speeds, and power draw.
            </li>
          </ul>
        </div>
      </section>
