    ...
    <>
      ...
      <section className="mb-12">
        ...
        <div className="bg-neutral-900/60 border border-neutral-700 rounded-xl p-6">
          ...
          <UniversalCopyCodeBlock code="http://localhost:9053/" />
          ...
          <UniversalCopyCodeBlock code='ergo.restApi.apiKeys = ["YOUR_API_KEY"]' />
      ...
      <section className="mb-12">
        ...
        <div className="space-y-6">
          <div className="bg-neutral-900/60 border border-neutral-700 rounded-xl p-6">
            ...
            <UniversalCopyCodeBlock code="GET /info" />
          ...
          <div className="bg-neutral-900/60 border border-neutral-700 rounded-xl p-6">
            ...
            <UniversalCopyCodeBlock code={`GET /wallet/balances
...
POST /wallet/transaction/send`} />
          ...
          <div className="bg-neutral-900/60 border border-neutral-700 rounded-xl p-6">
            ...
            <UniversalCopyCodeBlock code={`GET /blockchain/headers/last
