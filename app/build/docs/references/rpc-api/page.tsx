    ...
    <>
      ...
      <section className="mb-12">
        ...
        <div className="bg-neutral-900/60 border border-neutral-700 rounded-xl p-6">
          ...
          <pre className="bg-black text-orange-300 p-3 rounded-lg overflow-x-auto font-mono text-sm">{`http://localhost:9053/`}</pre>
          ...
          <pre className="bg-black text-orange-300 p-3 rounded-lg overflow-x-auto font-mono text-sm">{`ergo.restApi.apiKeys = ["YOUR_API_KEY"]`}</pre>
      ...
      <section className="mb-12">
        ...
        <div className="space-y-6">
          <div className="bg-neutral-900/60 border border-neutral-700 rounded-xl p-6">
            ...
            <pre className="bg-black text-cyan-300 p-3 rounded-lg overflow-x-auto font-mono text-sm">{`GET /info`}</pre>
          ...
          <div className="bg-neutral-900/60 border border-neutral-700 rounded-xl p-6">
            ...
            <pre className="bg-black text-cyan-300 p-3 rounded-lg overflow-x-auto font-mono text-sm">{`GET /wallet/balances
GET /wallet/boxes/unspent
POST /wallet/transaction/send`}</pre>
            <p className="text-gray-400 text-sm mt-2">
          ...
          <div className="bg-neutral-900/60 border border-neutral-700 rounded-xl p-6">
            ...
            <pre className="bg-black text-cyan-300 p-3 rounded-lg overflow-x-auto font-mono text-sm">{`GET /blockchain/headers/last
GET /blockchain/block/byid/{id}
GET /transactions/unconfirmed`}</pre>
            <p className="text-gray-400 text-sm mt-2">
