  ...
  return (
    <>
      ...
      <div className="mt-12 p-6 bg-gradient-to-r from-orange-500/10 to-cyan-500/10 border border-orange-500/20 rounded-xl">
        <h3 className="text-xl font-bold mb-4 text-white">Next Steps: Explore Ergo's Core Technologies</h3>
        <div className="grid md:grid-cols-2 gap-6">
          <div>
            <h4 className="font-semibold mb-2 text-orange-400">Understand the eUTXO Model</h4>
            <p className="text-gray-400 text-sm mb-3">
              Deepen your understanding of how Ergo's state is managed and secured.
            </p>
            <Link
              href="/build/docs/eutxo"
              className="inline-flex items-center text-orange-400 hover:text-orange-300 text-sm font-medium"
            >
              eUTXO Model Guide <ChevronRight className="w-4 h-4 ml-1" />
            </Link>
          </div>
          <div>
            <h4 className="font-semibold mb-2 text-cyan-400">Learn About Ergo's Consensus</h4>
            <p className="text-gray-400 text-sm mb-3">
              Discover more about Autolykos v2 and its role in network security.
            </p>
            <Link
              href="/technology/secure-pow"
              className="inline-flex items-center text-cyan-400 hover:text-cyan-300 text-sm font-medium"
            >
              Secure Proof-of-Work <ChevronRight className="w-4 h-4 ml-1" />
            </Link>
          </div>
        </div>
      </div>
