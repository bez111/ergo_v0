      ...
      <div className="space-y-6">
        ...
        <section className="bg-neutral-800/50 rounded-xl p-6 border border-neutral-700">
          ...
          <div className="text-gray-300">
            <p>
              The concept is illustrated through various examples, including contracts for a <Link href="/docs/developers/ergoscript-languages/wallet-interaction/multi-stage-protocols/rock-paper-scissor" className="text-cyan-400 hover:underline">Rock Paper Scissors game with provable fairness</Link>, a <Link href="/docs/developers/ergoscript-languages/wallet-interaction/multi-stage-protocols/reversible-address" className="text-cyan-400 hover:underline">Reversible Address with anti-theft features</Link>, and a <Link href="/docs/developers/ergoscript-languages/wallet-interaction/multi-stage-protocols/ico" className="text-cyan-400 hover:underline">comprehensive ICO</Link>.
            </p>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            <Link
              href="/docs/developers/ergoscript-languages/wallet-interaction/multi-stage-protocols/transaction-chains"
            ...
            <Link
              href="/docs/developers/ergoscript-languages/wallet-interaction/multi-stage-protocols/transaction-trees"
              className="bg-neutral-900/50 border border-neutral-700 rounded-xl p-6 hover:border-neutral-600 hover:border-orange-400 transition-all duration-300 flex flex-col justify-between min-h-[180px] cursor-pointer group relative"
            >
              <div>
                <h3 className="text-xl font-bold mb-3 flex items-center gap-2">
            ...
            <Link
              href="/docs/developers/ergoscript-languages/wallet-interaction/multi-stage-protocols/transaction-graphs"
              className="bg-neutral-900/50 border border-neutral-700 rounded-xl p-6 hover:border-neutral-600 hover:border-orange-400 transition-all duration-300 flex flex-col justify-between min-h-[180px] cursor-pointer group relative"
            >
              <div>
                <h3 className="text-xl font-bold mb-3 flex items-center gap-2">
            ...
            <Link
              href="/docs/developers/ergoscript-languages/wallet-interaction/multi-stage-protocols/context-enrichment"
              className="bg-neutral-900/50 border border-neutral-700 rounded-xl p-6 hover:border-neutral-600 hover:border-orange-400 transition-all duration-300 flex flex-col justify-between min-h-[180px] cursor-pointer group relative"
            >
              <div>
                <h3 className="text-xl font-bold mb-3 flex items-center gap-2">
            ...
            <Link
              href="/docs/developers/ergoscript-languages/wallet-interaction/multi-stage-protocols/multi-stage-transactions"
              className="bg-neutral-900/50 border border-neutral-700 rounded-xl p-6 hover:border-neutral-600 hover:border-orange-400 transition-all duration-300 flex flex-col justify-between min-h-[180px] cursor-pointer group relative"
            >
              <div>
                <h3 className="text-xl font-bold mb-3 flex items-center gap-2">
            ...
            <Link
              href="/docs/developers/ergoscript-languages/wallet-interaction/multi-stage-protocols/examples"
              className="bg-neutral-900/50 border border-neutral-700 rounded-xl p-6 hover:border-neutral-600 hover:border-orange-400 transition-all duration-300 flex flex-col justify-between min-h-[180px] cursor-pointer group relative"
            >
              <div>
                <h3 className="text-xl font-bold mb-3 flex items-center gap-2">
