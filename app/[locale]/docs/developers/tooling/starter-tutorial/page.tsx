  ...
  return (
    <>
      ...
      <div className="mb-6">
        ...
        <CodeBlock language="typescript">{`implementation ("org.ergoplatform:ergo-appkit_2.12:5.0.0")`}</CodeBlock>
        <h3 className="font-semibold text-orange-400 mb-2">Maven</h3>
        <CodeBlock language="typescript">{`<dependency>\n  <groupId>org.ergoplatform</groupId>\n  <artifactId>ergo-appkit_2.12</artifactId>\n  <version>5.0.0</version>\n</dependency>`}</CodeBlock>
        <h3 className="font-semibold text-orange-400 mb-2">npm</h3>
        <CodeBlock language="typescript">{`npm install @fleet-sdk/core`}</CodeBlock>
        <h3 className="font-semibold text-orange-400 mb-2">yarn</h3>
        <CodeBlock language="typescript">{`yarn install @fleet-sdk/core`}</CodeBlock>
        <h3 className="font-semibold text-orange-400 mb-2">pip</h3>
        <CodeBlock language="typescript">{`pip install ergpy`}</CodeBlock>
      </div>
