        ...
        data={{
          ...
          itemListElement: [
            ...
            },
            {
              ...
              position: 2,
              name: t("title"),
              item: "https://ergoblockchain.org/learn/guides"
            }
          ]
        }}
      />
        ...
        <div className="sr-only">
          <Breadcrumbs
            items={[
              ...
              { name: t("title"), href: "/learn/guides" }
            ]}
            className="mb-8"
          />
        </div>
                ...
                <Card className="bg-neutral-900/50 border-neutral-700 backdrop-blur-sm h-full">
                  <CardHeader>
                    <div className="flex items-center space-x-3">
                      ...
                      <CardTitle className="text-white">{t("categories.tutorials.title")}</CardTitle>
                    </div>
                  </CardHeader>
                  <CardContent>
                    <p className="text-neutral-400 leading-relaxed">
                      {t("categories.tutorials.description")}
                    </p>
                  </CardContent>
                </Card>
              </div>
