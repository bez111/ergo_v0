...
export default function MiningPage() {
  const t = useTranslations("ecosystem.mining")
        ...
        data={{
          ...
          itemListElement: [
            ...
            },
            {
              ...
              position: 2,
              name: t("title"),
              item: "https://ergoblockchain.org/ecosystem/mining"
            }
          ]
        }}
      />
        ...
        <div className="sr-only">
          <Breadcrumbs
            items={[
              ...
              { name: t("title"), href: "/ecosystem/mining" }
            ]}
            className="mb-8"
          />
        </div>
                ...
                <Card className="bg-neutral-900/50 border-neutral-700 backdrop-blur-sm h-full">
                  <CardHeader>
                    <div className="flex items-center space-x-3">
                      ...
                      <CardTitle className="text-white">{t("features.pools.title")}</CardTitle>
                    </div>
                  </CardHeader>
                  <CardContent>
                    <p className="text-neutral-400 leading-relaxed">
                      {t("features.pools.description")}
                    </p>
                  </CardContent>
                </Card>
              </div>
