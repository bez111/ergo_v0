    ...
    <Tabs defaultValue="overview" className="w-full">
      ...
      <TabsContent value="state-growth">
        ...
        <div className="bg-neutral-900/50 border border-neutral-700 rounded-xl p-6 mb-8 flex flex-col items-center">
          <img src="/Docs/introduction/storage-rent/fee-3d.png" alt="3D Fee Model: Space, Time, Computation" className="max-w-lg w-full rounded-xl border border-neutral-700 shadow-lg mb-2" />
