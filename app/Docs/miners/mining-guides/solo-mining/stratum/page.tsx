    ...
    <>
      ...
      <div className="bg-neutral-900/50 border border-neutral-700 rounded-xl p-6 mb-8">
        ...
        <div className="space-y-4">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-gray-300">
                  Setup a <Link href="/Docs/miners/mining-guides/solo-mining" className="text-blue-400 hover:text-blue-300 underline">Ergo Node for solo mining</Link>, making sure to include the EIP27 rules.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-gray-300 mb-2">
                  Setup <a href="https://github.com/mhssamadani/ErgoStratumServer" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-300 underline inline-flex items-center gap-1">
          ...
          <div className="bg-neutral-800/50 border border-neutral-600 rounded-lg p-4">
            <div className="flex items-start gap-3">
              <div className="bg-blue-500/70 text-white rounded-full w-6 h-6 flex items-center justify-center text-sm font-bold mt-1">3</div>
              <div>
                <h3 className="text-lg font-semibold text-white mb-2">Optional: NOMP Portal</h3>
                <p className="text-gray-300">
                  Point <a href="https://github.com/btclinux/ergo-nomp" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-300 underline inline-flex items-center gap-1">
      ...
      <div className="bg-neutral-900/50 border border-neutral-700 rounded-xl p-6 mb-8">
        ...
        <div className="space-y-4">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <ul className="space-y-2 text-gray-300">
                  ...
                  <li>• Is your <Link href="/Docs/miners/mining-guides/solo-mining" className="text-blue-400 hover:text-blue-300 underline">ergo.conf</Link> configured correctly?</li>
          ...
          <div className="bg-blue-900/20 border border-blue-700/50 rounded-lg p-4">
            ...
            <div className="relative bg-neutral-800/50 rounded-lg p-3 border border-neutral-600">
              <CopyButton 
          ...
          <div>
            ...
            <div className="space-y-3">
              <a 
                ...
                className="block bg-neutral-800/50 border border-neutral-600 rounded-lg p-4 hover:border-blue-500/50 hover:bg-neutral-700/50 transition-all group"
              >
                <h4 className="text-white group-hover:text-blue-400 transition-colors">Ergo Node + Stratum Server Tutorial</h4>
              ...
              <a 
                ...
                className="block bg-neutral-800/50 border border-neutral-600 rounded-lg p-4 hover:border-blue-500/50 hover:bg-neutral-700/50 transition-all group"
              >
                <h4 className="text-white group-hover:text-blue-400 transition-colors">Mine Ergo from your own Node</h4>
          ...
          <div>
            ...
            <div className="space-y-3">
              <a 
                ...
                className="block bg-neutral-800/50 border border-neutral-600 rounded-lg p-4 hover:border-blue-500/50 hover:bg-neutral-700/50 transition-all group"
              >
                <h4 className="text-white group-hover:text-blue-400 transition-colors flex items-center gap-2">
