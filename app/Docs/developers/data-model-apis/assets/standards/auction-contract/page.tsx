    ...
    <>
      ...
      <div className="mb-10">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h1 className="text-4xl font-bold bg-gradient-to-r from-orange-400 to-yellow-400 bg-clip-text text-transparent leading-tight">
              EIP-0022: Auction Contract
            </h1>
            <p className="text-xl text-gray-400 mt-2">
              Standardized auction mechanisms for token trading
            </p>
          </div>
        </div>
        <div className="flex gap-4">
          ...
          <a 
            href="https://github.com/ergoplatform/eips/blob/master/eip-0022.md"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 px-4 py-2 bg-orange-600 hover:bg-orange-700 text-white rounded-xl transition-colors duration-200"
          >
      ...
      <div className="space-y-8">
        <section>
          ...
          <p className="text-gray-300 mb-4">
            Decentralized auctioning of any kind of tokens (artwork, share tokens, etc.) is an important part of any blockchain. This EIP is proposing the auction contract with various features listed in the <a href="#design" className="text-orange-400 hover:text-orange-300 underline">Design</a> section
          </p>
        </section>
        ...
        <section id="design">
          ...
          <ul className="list-disc list-inside space-y-2 text-gray-300 ml-4">
            <li>Any token as the auction's currency alongside ERG</li>
            <li>"Buy it now" which allows a buyer to instantly buy the auctioned token by paying the predefined amount in the auction's currency</li>
            <li>Auction duration as timestamp which is much more precise than block height and is independent of the network difficulty</li>
            <li>Auto extending the duration near the end of the auction based on a global config</li>
            <li>Minimum bid step - each bidder has to increase the previous bid at least by this amount</li>
            <li>Royalty - The original owner (whomever issued the token) gets a share of the auction every time his/her token is auctioned using a global config</li>
          </ul>
        </section>
