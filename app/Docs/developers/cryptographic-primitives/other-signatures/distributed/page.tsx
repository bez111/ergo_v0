    ...
    <>
      ...
      <div className="mb-8">
        ...
        <p className="text-lg text-gray-300 mb-6">
          Advanced distributed signature protocols in Ergo that enable secure multi-party signing with improved security and simplified API.
        </p>
  ...
  "publicHints": {
    "0": [
      ...
      },
      {
        ...
        <p className="text-gray-300 mb-8">
          As a result, we get a JSON-encoded transaction which can be broadcast via a POST request to <code className="bg-neutral-800 px-2 py-1 rounded">/transactions</code> to get the transaction onto the blockchain.
        </p>
        ...
        <div className="bg-neutral-800/30 border border-neutral-700/50 rounded-xl p-6 mb-8">
          <h3 className="text-2xl font-bold mb-4 text-white">Key Improvements</h3>
          <ul className="list-disc list-inside space-y-2 text-gray-300">
            <li><strong>Position-Aware Hints:</strong> All hints are now tied to specific positions within the sigma tree</li>
            <li><strong>Input-Specific Binding:</strong> Hints are tied to specific transaction inputs</li>
            <li><strong>Simplified API:</strong> The new API is easier to use and understand</li>
            <li><strong>Enhanced Security:</strong> Prevents potential secret key revelation through reused randomness</li>
          </ul>
        </div>
        ...
        <div className="bg-neutral-800/30 border border-neutral-700/50 rounded-xl p-6">
          ...
          <ul className="list-disc list-inside space-y-2 text-gray-300">
            <li><a href="https://github.com/ergoplatform/eips/pull/8" className="text-orange-400 hover:text-orange-300 underline">EIP-11 on distributed signatures</a></li>
          </ul>
        </div>
      </div>
    </>
