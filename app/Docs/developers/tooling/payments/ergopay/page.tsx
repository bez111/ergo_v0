...
export default function ErgoPayPage() {
  return (
    <>
      <h1 className="text-3xl font-bold bg-gradient-to-r from-orange-400 to-cyan-400 bg-clip-text text-transparent mb-6 leading-tight pb-1">ErgoPay</h1>
      <div className="mb-6 flex items-center gap-3">
        ...
        <Link
          href="/Docs/developers/tooling/payments/ergopay/tutorial"
      ...
      <h2 className="text-2xl font-bold text-cyan-400 mb-4">How to Try ErgoPay</h2>
      <ol className="list-decimal pl-6 text-gray-300 mb-6 space-y-1">
        <li>
          Ensure you have installed Ergo Wallet App 1.6. It's available on Google Play ({" "}
          <a href="https://play.google.com/apps/testing/org.ergoplatform.android" target="_blank" rel="noopener noreferrer" className="text-cyan-400 hover:underline">join</a>
          ) and on TestFlight (DM the dev your Apple ID to join). Alternatively, {" "}
          <a href="https://github.com/ergoplatform/ergo-wallet-app/releases" target="_blank" rel="noopener noreferrer" className="text-cyan-400 hover:underline">download the APK on GitHub</a> and sideload.
        </li>
        <li>
          Visit the demonstration app: {" "}
          <a href="https://golfgl.de/ergopayshowcase/" target="_blank" rel="noopener noreferrer" className="text-cyan-400 hover:underline">https://golfgl.de/ergopayshowcase/</a>. ErgoPay supports both mobile and desktop devices, and even Cold wallets.
        </li>
        <li>
        ...
        <li>
          Confirm the transaction and wait for your new token to be minted once the transaction is confirmed. <i>(Note: Emojis in the token name are supported.)</i>
        </li>
        <li>
          To burn a token, select the "Burn a token" option from the demonstration dApp. For this, the dApp needs to connect to your wallet to display a list of available tokens to burn. Do this by scanning the QR code or tapping the button.
        </li>
        <li>
          Once your wallet is connected, you can select the token to burn. <b>Be careful:</b> You can burn any token, so avoid choosing valuable tokens unless you intend to.
        </li>
        <li>
          Follow the same procedure as before to confirm the transaction and burn the token.
        </li>
      </ol>
      <div className="text-gray-300 mb-6 max-w-2xl">
        We hope you enjoy exploring ErgoPay! We look forward to seeing more dApps implementing the ErgoPay protocol.
      </div>
      <h2 className="text-2xl font-bold text-cyan-400 mb-4">Implementing a dApp using ErgoPay</h2>
      <div className="text-gray-300 mb-6 max-w-2xl">
      ...
      <h3 className="text-xl font-bold text-orange-400 mb-2">ErgoPay vs web dApp connector</h3>
      <div className="text-gray-300 mb-6 max-w-2xl">
      ...
      <ul className="list-disc pl-6 text-gray-300 mb-8 space-y-1">
        <li>
          <a href="https://github.com/MrStahlfelge/ergopay-payment-portal" target="_blank" rel="noopener noreferrer" className="text-cyan-400 hover:underline">
