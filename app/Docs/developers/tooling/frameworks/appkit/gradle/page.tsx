...
export default function GradlePage() {
  return (
    <>
      ...
      <UniversalCopyCodeBlock code={`implementation ('org.ergoplatform:ergo-appkit_2.11:4.0.6')`} />
...
implementation "org.bouncycastle:bcprov-jdk15to18:1.66"`} />
      ...
      <UniversalCopyCodeBlock code={`val retrofit = Retrofit.Builder()
...
val ergoApiService = retrofit.create(DefaultApi::class.java)`} />
      ...
      <UniversalCopyCodeBlock code={`val ergoClient = RestApiErgoClient.create(
    nodeApiAddress,
    NetworkType.MAINNET,
