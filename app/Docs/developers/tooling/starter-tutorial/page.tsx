  ...
  return (
    <>
      ...
      <div className="mb-6">
        ...
        <CodeBlock language="typescript">{`implementation ("org.ergoplatform:ergo-appkit_2.12:5.0.0")`} className="mb-4" />
        ...
        <CodeBlock language="typescript">{`npm install @fleet-sdk/core`} className="mb-4" />
        <h3 className="font-semibold text-orange-400 mb-2">yarn</h3>
        <CodeBlock language="typescript">{`yarn install @fleet-sdk/core`} className="mb-4" />
        <h3 className="font-semibold text-orange-400 mb-2">pip</h3>
        <CodeBlock language="typescript">{`pip install ergpy`} className="mb-4" />
      </div>
