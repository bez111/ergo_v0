...
import { Layers, Wrench, CreditCard, BookOpen } from "lucide-react";
import Link from "next/link";

const toolingSections = [
  {
    title: "Pathways",
    description: "Guided flows and recipes for building on Ergo.",
    icon: Layers,
    color: "text-cyan-400",
    link: "/Docs/developers/tooling/pathways"
  },
  {
    title: "Frameworks",
