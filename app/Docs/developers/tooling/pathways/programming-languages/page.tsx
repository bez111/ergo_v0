...
const cards = [
  {
    ...
    url: "/Docs/developers/tooling/pathways/programming-languages/jvm"
  },
  {
    title: "JavaScript",
    ...
    url: "/Docs/developers/tooling/pathways/programming-languages/javascript"
  },
  {
    title: "Rust",
    ...
    url: "/Docs/developers/tooling/pathways/programming-languages/rust"
  },
  {
    title: "Others",
    ...
    url: "/Docs/developers/tooling/pathways/programming-languages/others"
  }
];
...
export default function ProgrammingLanguagesPage() {
  return (
    <>
      ...
      <div className="mb-6">
        <Link
          href="/Docs/developers/tooling/pathways"
