...
const frameworks = [
  ...
  { title: "JDE", content: "JSON dApp Environment: a lightweight environment for running JSON-based dApps.", icon: <FileText className="w-8 h-8 text-cyan-400" />, url: "jde" }
];
const interpreters = [
  { title: "sigmastate-interpreter", content: "Reference JVM implementation of ErgoScript and ErgoTree, used in the core node and AppKit.", icon: <Cpu className="w-8 h-8 text-blue-400" />, url: "/Docs/developers/tooling/pathways/programming-languages/jvm" },
  { title: "Sigma-Rust", content: "Alternative Rust implementation of ErgoTree interpreter and transaction tools. Useful for cross-platform and WASM.", icon: <Wrench className="w-8 h-8 text-yellow-400" />, url: "/Docs/developers/tooling/pathways/sigma-rust" },
  { title: "Sigma.JS", content: "JavaScript/TypeScript library for parsing and working with ErgoTree scripts in web apps.", icon: <Code className="w-8 h-8 text-green-400" />, url: "/Docs/developers/tooling/pathways/sigmajs" }
];
const libraries = [
