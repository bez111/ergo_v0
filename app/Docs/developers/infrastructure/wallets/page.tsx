      ...
      <div className="mb-12">
        ...
        <div className="mb-12">
          ...
          <div className="bg-neutral-900/50 border border-neutral-700 rounded-xl p-6 mb-6">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="flex items-start gap-3">
                <Mobile className="w-6 h-6 text-green-400 mt-1 flex-shrink-0" />
                <div>
                  <h3 className="font-semibold text-green-400 mb-1">📱 Mobile Use</h3>
                  <p className="text-gray-300 text-sm">If you need access to your funds primarily on your smartphone (iOS or Android), look at <strong>Mobile Wallets</strong>.</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <Desktop className="w-6 h-6 text-blue-400 mt-1 flex-shrink-0" />
                <div>
                  <h3 className="font-semibold text-blue-400 mb-1">💻 Desktop Management</h3>
                  <p className="text-gray-300 text-sm">If you prefer managing funds on your computer (Windows, macOS, Linux), check out <strong>Desktop Wallets</strong>.</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <Browser className="w-6 h-6 text-purple-400 mt-1 flex-shrink-0" />
                <div>
                  <h3 className="font-semibold text-purple-400 mb-1">🌐 dApp Interaction</h3>
                  <p className="text-gray-300 text-sm">If you plan to frequently interact with Ergo dApps directly through your web browser, a <strong>Browser Extension Wallet</strong> is often the most convenient.</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <Security className="w-6 h-6 text-red-400 mt-1 flex-shrink-0" />
                <div>
                  <h3 className="font-semibold text-red-400 mb-1">🔒 Maximum Security</h3>
                  <p className="text-gray-300 text-sm">For storing significant amounts of ERG or holding funds offline ("cold storage"), consider a <strong>Paper Wallet</strong> or offline features.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="mb-12">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-neutral-900/50 border border-neutral-700 rounded-xl p-6">
              ...
              <a
                href="https://ergoplatform.org/en/ergo-wallet-app/"
                target="_blank"
        ...
        <div className="mb-12">
          <h2 className="text-2xl font-bold text-purple-400 mb-6 flex items-center">
            <Browser className="w-6 h-6 mr-3" />
            Browser Extension Wallets
          </h2>
          <div className="bg-neutral-900/50 border border-neutral-700 rounded-xl p-6">
        ...
        <div className="mb-12">
          <h2 className="text-2xl font-bold text-blue-400 mb-6 flex items-center">
            <Desktop className="w-6 h-6 mr-3" />
            Desktop Wallets
          </h2>
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-neutral-900/50 border border-neutral-700 rounded-xl p-6">
