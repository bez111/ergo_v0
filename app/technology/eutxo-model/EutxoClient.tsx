...
export default function EutxoClient() {
  ...
  return (
    <div className="min-h-screen relative">
      ...
      <SchemaOrg type="FAQPage" data={{ '@type': 'FAQPage', '@id': 'https://ergoblockchain.org/technology/eutxo-model#faq', mainEntity: faqs.map((faq) => ({ '@type': 'Question', name: faq.question, url: `https://ergoblockchain.org/technology/eutxo-model#${faq.question.toLowerCase().replace(/\s+/g,'-').replace(/[^a-z0-9\-]/g,'')}`, acceptedAnswer: { '@type': 'Answer', text: faq.answer } })) }} />
      ...
      <SchemaOrg type="TechArticle" data={{ '@type': 'TechArticle', headline: 'eUTXO Model — UTXO vs Account', description: 'Ergo eUTXO explained: security, parallelism, programmability, and use cases.', image: 'https://ergoblockchain.org/og/eutxo.png', datePublished: '2024-01-01', dateModified: new Date().toISOString().slice(0, 10), keywords: 'eUTXO, UTXO vs account, Ergo, smart contracts', articleSection: 'Technology', about: [ { '@type': 'Thing', name: 'UTXO' }, { '@type': 'Thing', name: 'Account-based model' }, { '@type': 'Thing', name: 'ErgoScript' } ], author: { '@type': 'Organization', name: 'Ergo Foundation', url: 'https://ergoblockchain.org' }, publisher: { '@type': 'Organization', name: 'Ergo Platform', url: 'https://ergoblockchain.org', logo: { '@type': 'ImageObject', url: 'https://ergoblockchain.org/og/logo-512.png' } }, isPartOf: { '@type': 'WebSite', '@id': 'https://ergoblockchain.org#website' }, mainEntityOfPage: 'https://ergoblockchain.org/technology/eutxo-model' }} />
    </div>
  )
} 