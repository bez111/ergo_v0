...
const checks = [
  ...
  { path: "/agents/reputation", expect: [200] },
  ...
  { path: "/agent-economy/agent-reputation.schema.v0.json", expect: [200] },
  ...
  { path: "/api/agents/reputation", expect: [200] },
...
const hostChecks = process.env.CHECK_AGENT_HOSTS === "true"
  ? [
      ...
      { url: "https://agents.ergoblockchain.org/reputation", expect: [200], label: "agents reputation" },
      ...
      { url: "https://agents.ergoblockchain.org/api/reputation", expect: [200], label: "agents api/reputation" },
