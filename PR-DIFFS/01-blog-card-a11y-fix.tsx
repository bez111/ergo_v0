// ✅ ГОТОВЫЙ PR-DIFF: Исправление BlogCard - устранение вложенных ссылок
// Файл: app/blog/_components/blog-card.tsx
...
1. Убрали 'use client' - теперь RSC для лучшей производительности
2. Устранили вложенные ссылки - каждая ссылка независима
3. Добавили фиксированные размеры изображений (aspect-ratio)
4. Улучшили focus indicators с focus-visible
5. Добавили proper ARIA labels и semantic markup
6. Исправили ALT тексты для изображений
*/ 