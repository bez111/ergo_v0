...
export const technologyTopics: TechnologyTopic[] = [
  {
    ...
    keywords: ["eutxo", "utxo", "smart contracts", "parallel execution", "composability", "mev resistance"],
  ...
  },
  {
    ...
    keywords: ["ergoscript", "smart contracts", "formal verification", "sigma protocols", "type safety"],
  ...
  },
  {
    ...
    keywords: ["autolykos", "proof of work", "pow", "mining", "asic resistant", "gpu mining", "decentralization"],
  ...
  },
  {
    ...
    keywords: ["storage rent", "sustainability", "state bloat", "miner revenue", "tokenomics"],
  ...
  },
  {
    ...
    keywords: ["sigma protocols", "privacy", "zero knowledge proofs", "zkp", "ring signatures", "ergomixer"],
  ...
  },
  {
    ...
    keywords: ["nipopows", "light clients", "mobile wallet", "cross chain", "bridges", "sidechains"],
  ...
  },
  {
    ...
    keywords: ["oracle pools", "oracles", "price feeds", "data feeds", "defi infrastructure"],
    relatedTopics: ["ergoscript", "eutxo-model"],
  ...
  },
  {
    ...
    keywords: ["babel fees", "transaction fees", "ux", "token payments"],
