    ...
    rules: [
      {
        ...
        allow: [
          ...
          '/agent-economy/agent-reputation.schema.v0.json',
          '/agent-economy/agent-service-publish.schema.v0.json',
          '/agent-economy/provider-onboarding.schema.v0.json',
          '/agent-economy/agent-jobs.schema.v0.json',
          '/agent-economy/agent-job-acceptance.schema.v0.json',
          '/agent-economy/agent-job-quote.schema.v0.json',
          '/agent-economy/ergo-connect.schema.v0.json',
