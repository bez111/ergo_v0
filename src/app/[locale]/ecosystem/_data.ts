...
export const projects: EcosystemProject[] = [
  ...
  { id: 5, name: "Ergo Auction House", category: "NFT", status: "OPERATIONAL", description: "The first open-source NFT marketplace on Ergo. It supports artist royalties, on-site minting, various auction types, and multiple currencies.", icon: "🖼️", url: "https://ergoauctions.org" },
  ...
  { id: 12, name: "SkyHarbor", category: "NFT", status: "TESTING", description: "An NFT marketplace on Ergo, positioned as a reliable platform for fixed-price NFT transactions with planned features like NFT refunds and financing.", icon: "🏪", url: "#" },
  ...
  { id: 28, name: "Lilium", category: "TOOLS", status: "TESTING", description: "A platform designed to facilitate the launch of NFT collections on the Ergo blockchain, helping artists and projects mint and sell NFTs.", icon: "🌸", url: "#" },
