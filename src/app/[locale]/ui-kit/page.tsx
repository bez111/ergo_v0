...
export default function UIKitPage() {
  const t = useTranslations("ui-kit")
            ...
            <div className="max-w-7xl mx-auto">
              <div className="text-center">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <a href="https://github.com/ergoplatform/ergo-ui-kit" target="_blank" rel="noopener noreferrer">
                ...
                <Card className="bg-neutral-900/50 border-neutral-700 backdrop-blur-sm h-full">
                  <CardHeader>
                    <div className="flex items-center space-x-3">
                      ...
                      <CardTitle className="text-white">{t("features.components.title")}</CardTitle>
                    </div>
                  </CardHeader>
                  <CardContent>
