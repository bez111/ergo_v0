...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      images: [{ url: "https://www.ergoblockchain.org/og/ergoscript.jpg", width: 1200, height: 630, alt: "ErgoScript Programming Course" }],
      type: "article",
    },
    twitter: {
      ...
      title,
      description,
      images: ["https://www.ergoblockchain.org/og/ergoscript.jpg"]
    }
  }
}
