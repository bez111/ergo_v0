...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      images: [{ url: "https://www.ergoblockchain.org/og/hubs/playbooks.jpg", width: 1200, height: 630, alt: "Ergo Playbooks - Step-by-Step Guides" }]
    },
    twitter: {
      card: "summary_large_image",
      title,
      description,
      images: ["https://www.ergoblockchain.org/og/hubs/playbooks.jpg"]
    },
