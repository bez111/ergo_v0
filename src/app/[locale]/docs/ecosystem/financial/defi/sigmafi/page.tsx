      ...
      <div className="grid md:grid-cols-2 gap-6 mb-12">
        <div className="bg-neutral-900/50 border border-neutral-700 rounded-xl p-6">
          ...
          <p className="text-gray-300 mb-4">
            Trading, farming, and lending are managed by open-source smart contracts, improving transparency for users. There is no custodial operator; smart-contract and liquidity risks still remain.
          </p>
