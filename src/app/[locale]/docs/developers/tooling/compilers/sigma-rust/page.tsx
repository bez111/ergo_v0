            ...
            <div>
              <p className="mb-2">
                ...
                <a href="https://crates.io/crates/ergo-lib" target="_blank" rel="noopener noreferrer">
                  <Image src="https://img.shields.io/crates/v/ergo-lib.svg" alt="Latest Version" width={100} height={20} className="inline" />
                </a>{' '}
                <a href="https://docs.rs/crate/ergo-lib" target="_blank" rel="noopener noreferrer">
                  <Image src="https://docs.rs/ergo-lib/badge.svg" alt="Documentation" width={100} height={20} className="inline" />
                </a>
              </p>
              <p>
            ...
            <div>
              <p className="mb-2">
                ...
                <a href="https://crates.io/crates/ergotree-interpreter" target="_blank" rel="noopener noreferrer">
                  <Image src="https://img.shields.io/crates/v/ergotree-interpreter.svg" alt="Latest Version" width={140} height={20} className="inline" />
                </a>{' '}
                <a href="https://docs.rs/crate/ergotree-interpreter" target="_blank" rel="noopener noreferrer">
                  <Image src="https://docs.rs/ergotree-interpreter/badge.svg" alt="Documentation" width={100} height={20} className="inline" />
                </a>
              </p>
            ...
            <div>
              <p className="mb-2">
                ...
                <a href="https://crates.io/crates/ergotree-ir" target="_blank" rel="noopener noreferrer">
                  <Image src="https://img.shields.io/crates/v/ergotree-ir.svg" alt="Latest Version" width={110} height={20} className="inline" />
                </a>{' '}
                <a href="https://docs.rs/crate/ergotree-ir" target="_blank" rel="noopener noreferrer">
                  <Image src="https://docs.rs/ergotree-ir/badge.svg" alt="Documentation" width={100} height={20} className="inline" />
                </a>
              </p>
            ...
            <div>
              <p className="mb-2">
                ...
                <a href="https://crates.io/crates/ergoscript-compiler" target="_blank" rel="noopener noreferrer">
                  <Image src="https://img.shields.io/crates/v/ergoscript-compiler.svg" alt="Latest Version" width={160} height={20} className="inline" />
                </a>{' '}
                <a href="https://docs.rs/crate/ergoscript-compiler" target="_blank" rel="noopener noreferrer">
                  <Image src="https://docs.rs/ergoscript-compiler/badge.svg" alt="Documentation" width={130} height={20} className="inline" />
                </a>
              </p>
            ...
            <div>
              <p className="mb-2">
                ...
                <a href="https://crates.io/crates/sigma-ser" target="_blank" rel="noopener noreferrer">
                  <Image src="https://img.shields.io/crates/v/sigma-ser.svg" alt="Latest Version" width={120} height={20} className="inline" />
                </a>{' '}
                <a href="https://docs.rs/crate/sigma-ser" target="_blank" rel="noopener noreferrer">
                  <Image src="https://docs.rs/sigma-ser/badge.svg" alt="Documentation" width={100} height={20} className="inline" />
                </a>
              </p>
              ...
              <ul className="list-disc pl-6 mt-2">
                <li>
                  ...
                  <a href="https://crates.io/crates/ergo-lib-wasm" target="_blank" rel="noopener noreferrer">
                    <Image src="https://img.shields.io/crates/v/ergo-lib-wasm.svg" alt="Latest Version" width={150} height={20} className="inline" />
                  </a>{' '}
                  <a href="https://docs.rs/crate/ergo-lib-wasm" target="_blank" rel="noopener noreferrer">
                    <Image src="https://docs.rs/ergo-lib-wasm/badge.svg" alt="Documentation" width={150} height={20} className="inline" />
                  </a>
                </li>
              </ul>
            </li>
              ...
              <ul className="list-disc pl-6 mt-2 space-y-1">
                <li>
                  ...
                  <a href="https://www.npmjs.com/package/ergo-lib-wasm-browser" target="_blank" rel="noopener noreferrer">
                    <Image src="https://img.shields.io/npm/v/ergo-lib-wasm-browser" alt="Latest version" width={190} height={20} className="inline" />
                  </a>
                </li>
                <li>
                  Node.js:{' '}
                  ...
                  <a href="https://www.npmjs.com/package/ergo-lib-wasm-nodejs" target="_blank" rel="noopener noreferrer">
                    <Image src="https://img.shields.io/npm/v/ergo-lib-wasm-nodejs" alt="Latest version" width={190} height={20} className="inline" />
                  </a>
                </li>
              </ul>
            </li>
              ...
              <ul className="list-disc pl-6 mt-2">
                <li>
                  ...
                  <a href="https://crates.io/crates/ergo-lib-jni" target="_blank" rel="noopener noreferrer">
                    <Image src="https://img.shields.io/crates/v/ergo-lib-jni.svg" alt="Latest Version" width={150} height={20} className="inline" />
                  </a>{' '}
                  <a href="https://docs.rs/crate/ergo-lib-jni" target="_blank" rel="noopener noreferrer">
                    <Image src="https://docs.rs/ergo-lib-jni/badge.svg" alt="Documentation" width={140} height={20} className="inline" />
                  </a>
                </li>
              </ul>
            </li>
              ...
              <ul className="list-disc pl-6 mt-2">
                <li>
                  ...
                  <a href="https://crates.io/crates/ergo-lib-c" target="_blank" rel="noopener noreferrer">
                    <Image src="https://img.shields.io/crates/v/ergo-lib-c.svg" alt="Latest Version" width={140} height={20} className="inline" />
                  </a>{' '}
                  <a href="https://docs.rs/crate/ergo-lib-c" target="_blank" rel="noopener noreferrer">
                    <Image src="https://docs.rs/ergo-lib-c/badge.svg" alt="Documentation" width={120} height={20} className="inline" />
                  </a>
                </li>
              </ul>
            </li>
              ...
              <ul className="list-disc pl-6 mt-2">
                <li>
                  ...
                  <a href="https://pkg.go.dev/github.com/ergoplatform/ergo-lib-go" target="_blank" rel="noopener noreferrer">
                    <Image src="https://pkg.go.dev/badge/github.com/ergoplatform/ergo-lib-go.svg" alt="Go Reference" width={220} height={20} className="inline" />
                  </a>{' '}
              ...
              <ul className="list-disc pl-6 mt-2">
                <li>
                  ...
                  <a href="https://badge.fury.io/rb/sigma_rb" target="_blank" rel="noopener noreferrer">
                    <Image src="https://badge.fury.io/rb/sigma_rb.svg" alt="Gem Version" width={170} height={20} className="inline" />
                  </a>{' '}
                  <em>(Note: Community maintained)</em>
                </li>
              </ul>
              ...
              <ul className="list-disc pl-6 mt-2 space-y-1">
                <li>
                  ...
                  <a href="https://badge.fury.io/py/ergo-lib" target="_blank" rel="noopener noreferrer">
                    <Image src="https://badge.fury.io/py/ergo-lib.svg" alt="PyPI version" width={150} height={20} className="inline" />
                  </a>{' '}
                  <a href="https://docs.rs/crate/ergo-lib" target="_blank" rel="noopener noreferrer">
                    <Image src="https://docs.rs/ergo-lib/badge.svg" alt="Documentation" width={100} height={20} className="inline" />
                  </a>{' '}
