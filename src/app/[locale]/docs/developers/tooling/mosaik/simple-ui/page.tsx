...
function TutorialImagePlaceholder({ label }: { label: string }) {
  return (
    <div className="mb-6 flex aspect-video w-full items-center justify-center rounded-xl border border-neutral-700 bg-neutral-900/70 text-sm text-gray-400">
      {label}
    </div>
  );
}
...
export default function MosaikSimpleUIPage() {
  return (
    <>
      ...
      <TutorialImagePlaceholder label="Spring Initializr screenshot" />
...
fun getMainPage(): MosaikApp {
   ...
   card {
      ...
      <TutorialImagePlaceholder label="Mosaik simple UI screenshot" />
...
card {
   column(Padding.DEFAULT) {
      ...
      <TutorialImagePlaceholder label="Mosaik UI with button screenshot" />
