...
export default function SigmaRustConstrainedPage() {
  return (
    <>
      ...
      <div className="mb-6">
        <Link
          href="/docs/developers/tooling/sigma-rust"
