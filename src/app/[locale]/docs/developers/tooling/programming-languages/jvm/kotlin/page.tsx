  ...
  return (
    <>
      ...
      <p className="text-lg text-gray-300 mb-6 max-w-2xl">
        Given that Kotlin is predominantly used as a <Link href="/docs/developers/tooling/programming-languages/jvm" className="text-cyan-400 hover:underline">JVM</Link> language, please refer to our <Link href="/docs/developers/tooling/frameworks/appkit" className="text-cyan-400 hover:underline">AppKit Guide</Link> for additional resources.
      </p>
      <p className="text-lg text-gray-300 mb-6 max-w-2xl">
      ...
      <p className="text-lg text-gray-300 mb-6 max-w-2xl">
        For a practical demonstration of how to utilize <Link href="/docs/developers/tooling/frameworks/appkit" className="text-cyan-400 hover:underline">AppKit</Link> in Kotlin, consider reviewing the {" "}
