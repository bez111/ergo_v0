  ...
  return (
    <>
      ...
      <p className="text-lg text-gray-300 mb-6 max-w-2xl">
        On-chain contracts are developed in ErgoScript, a simple language designed for writing <Link href="/docs/developers/tooling/ergoscript" className="text-cyan-400 hover:underline">smart contracts</Link> on the Ergo blockchain. ErgoScript is a Turing-complete language that prioritizes <Link href="/docs/technology/privacy-features" className="text-cyan-400 hover:underline">security</Link> and is well-suited for the <Link href="/docs/developers/data-model-apis/anatomy/eutxo" className="text-cyan-400 hover:underline">UTXO transactional model</Link> used by Ergo.
      </p>
      <p className="text-lg text-gray-300 mb-6 max-w-2xl">
