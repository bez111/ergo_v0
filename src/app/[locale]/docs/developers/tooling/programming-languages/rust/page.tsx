  ...
  return (
    <>
      ...
      <p className="text-lg text-gray-300 mb-6 max-w-2xl">
        On-chain contracts are developed in ErgoScript, a simple language designed for writing <Link href="/docs/developers/tooling" className="text-cyan-400 hover:underline">smart contracts</Link> on the Ergo blockchain. ErgoScript is a Turing-complete language that prioritizes <Link href="/technology/privacy-features" className="text-cyan-400 hover:underline">security</Link> and is well-suited for the <Link href="/docs/developers/data-model-apis" className="text-cyan-400 hover:underline">UTXO transactional model</Link> used by Ergo.
      </p>
      <p className="text-lg text-gray-300 mb-6 max-w-2xl">
        For <Link href="/docs/developers/tooling" className="text-cyan-400 hover:underline">off-chain components</Link>, such as interacting with the blockchain, creating <Link href="/docs/developers/tooling" className="text-cyan-400 hover:underline">transactions</Link>, and building <Link href="/docs/ecosystem/applications" className="text-cyan-400 hover:underline">applications</Link>, developers can use Rust along with frameworks like <Link href="/docs/developers/tooling/sigma-rust" className="text-cyan-400 hover:underline">sigma-rust</Link>. Rust provides a powerful and efficient language for building off-chain components, while sigma-rust provides a Rust port of the <Link href="/docs/developers/cryptographic-primitives" className="text-cyan-400 hover:underline">sigmastate-interpreter</Link>, allowing developers to interact with the Ergo blockchain from their Rust applications. Various <Link href="/docs/developers/tooling/sigma-rust#bindings" className="text-cyan-400 hover:underline">language bindings for sigma-rust</Link> are available for other languages.
      </p>
      <p className="text-lg text-gray-300 mb-6 max-w-2xl">
        One example of using Rust for off-chain components is the <Link href="/docs/ecosystem/infrastructure/oracles" className="text-cyan-400 hover:underline">Oracle Pools project</Link>, a federated protocol for delivering external data to the Ergo blockchain. The on-chain contracts and descriptions are available in the <Link href="/docs/ecosystem/Standards" className="text-cyan-400 hover:underline">Ergo Improvement Proposals (EIPs)</Link>, while the off-chain part is implemented in Rust using the <a href="https://github.com/ergoplatform/oracle-core" target="_blank" rel="noopener noreferrer" className="text-cyan-400 hover:underline">oracle-core</a> repository.
      </p>
      <p className="text-lg text-gray-300 mb-6 max-w-2xl">
        Understanding the <Link href="/docs/introduction/eutxo" className="text-cyan-400 hover:underline">UTXO transactional model</Link> is crucial when developing off-chain components for Ergo, as it differs from the <Link href="/docs/introduction/utxo-vs-account" className="text-cyan-400 hover:underline">account-based model</Link> used by other blockchains. Developers with experience in parallel computing may find the UTXO model more natural to work with.
      </p>
