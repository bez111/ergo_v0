...
export default function CSharpPage() {
  return (
    <>
      ...
      <p className="text-gray-300 mb-4 max-w-2xl">
        <Link href="/docs/developers/tooling/fleetsharp" className="text-cyan-400 hover:underline">FleetSharp</Link> is an ongoing open-source project. It is a sigma-type (<Link href="/docs/developers/ergoscript-languages/ergoscript-vs-ergotree" className="text-cyan-400 hover:underline">ErgoTree</Link>) <Link href="/docs/developers/ergoscript-languages/ergoscript-vs-ergotree#serialization" className="text-cyan-400 hover:underline">serializer/deserializer</Link> based on <Link href="/docs/developers/tooling/fleet" className="text-cyan-400 hover:underline">Fleet</Link>. This tool simplifies the process of converting <Link href="/docs/developers/data-model-apis" className="text-cyan-400 hover:underline">data</Link> between compatible formats for <Link href="/docs/developers/infrastructure/node/p2p" className="text-cyan-400 hover:underline">communication</Link> and <Link href="/docs/introduction/storage-rent" className="text-cyan-400 hover:underline">storage</Link>.
      </p>
      <p className="text-gray-300 mb-4 max-w-2xl">
