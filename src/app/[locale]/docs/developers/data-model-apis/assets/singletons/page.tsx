      ...
      <div className="space-y-8">
        ...
        <div className="bg-neutral-800/50 border border-neutral-700 rounded-xl p-8">
          ...
          <p className="text-gray-300 mb-4">
            One specific example of a singular token is an <Link href="/docs/developers/data-model-apis/assets/singletons" className="text-cyan-400 hover:underline">oracle</Link>. For instance, a token can be created to act as an ERG/EUR exchange rates oracle.
          </p>
          <p className="text-gray-300 mb-6">
