      ...
      <div className="space-y-6">
        ...
        <section className="bg-neutral-800/50 rounded-xl p-6 border border-neutral-700">
          ...
          <div className="text-gray-300">
            <p>
              The concept is illustrated through various examples, including contracts for a <Link href="/docs/developers/ergoscript-languages/wallet-interaction/multi-stage-protocols" className="text-cyan-400 hover:underline">Rock Paper Scissors game with provable fairness</Link>, a <Link href="/docs/developers/ergoscript-languages/wallet-interaction/multi-stage-protocols" className="text-cyan-400 hover:underline">Reversible Address with anti-theft features</Link>, and a <Link href="/docs/developers/ergoscript-languages/wallet-interaction/multi-stage-protocols" className="text-cyan-400 hover:underline">comprehensive ICO</Link>.
            </p>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            <Link
              href="/docs/developers/ergoscript-languages/wallet-interaction/multi-stage-protocols"
