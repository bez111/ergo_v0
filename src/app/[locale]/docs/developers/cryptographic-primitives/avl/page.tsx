    ...
    <div className="space-y-8">
      ...
      <div className="space-y-8">
        ...
        <section className="bg-neutral-800/50 rounded-xl p-6 border border-neutral-700">
          ...
          <p className="text-gray-300 mb-6">
            Developers can effortlessly integrate AVL trees into their Ergo applications with the help of the <a href="/docs/developers/cryptographic-primitives/avl" className="text-blue-400 hover:text-blue-300 underline">GetBlok Plasma</a> library, which is built on the <a href="/docs/developers/tooling/frameworks/appkit" className="text-blue-400 hover:text-blue-300 underline">Ergo Appkit</a>. This library streamlines the integration process by offering an abstraction layer that aids in incorporating AVL trees (also referred to as Plasma) into <a href="/docs/developers/infrastructure/offchain" className="text-blue-400 hover:text-blue-300 underline">off-chain code</a>. It provides developers with a convenient method to utilize AVL trees as a <a href="/docs/introduction/roadmap/scaling-roadmap" className="text-blue-400 hover:text-blue-300 underline">Layer-2 scaling solution</a> in <a href="/docs/developers/ergoscript-languages" className="text-blue-400 hover:text-blue-300 underline">smart contracts</a>, off-chain code, and distributed systems that manage the Plasma infrastructure.
          </p>
        </section>
