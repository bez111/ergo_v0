  ...
  return (
    <>
      ...
      <div className="prose prose-invert max-w-none">
        ...
        <ul className="list-disc list-inside space-y-2 text-gray-300 mb-8">
          <li><Link href="/docs/developers/cryptographic-primitives/other-signatures/threshold/3-out-of-5" className="text-orange-400 hover:text-orange-300">3-out-of-5 Threshold Signature</Link></li>
        </ul>
        ...
        <ol className="list-decimal list-inside space-y-2 text-gray-300 mb-8">
          <li><strong>Corporate Governance:</strong>
            <ul className="list-disc list-inside ml-6 mt-2 space-y-1">
              ...
              <li><Link href="/docs/developers/cryptographic-primitives/other-signatures/threshold" className="text-orange-400 hover:text-orange-300">Microcredit Scenario</Link></li>
            </ul>
          </li>
          <li><strong>Cross-Chain Interoperability:</strong>
            <ul className="list-disc list-inside ml-6 mt-2 space-y-1">
              <li><Link href="/ecosystem/rosen-bridge" className="text-orange-400 hover:text-orange-300">Rosen Bridge Mechanisms</Link></li>
            </ul>
          </li>
        </ol>
  ...
  atLeastKOutOfN(
    ...
    publicKeys = List(
      ...
      pubKey4, pubKey5
        ...
        <ul className="list-disc list-inside space-y-2 text-gray-300 mb-8">
          <li><Link href="/docs/developers/cryptographic-primitives/other-signatures" className="text-orange-400 hover:text-orange-300">Sigma Protocols</Link></li>
        ...
        <ul className="list-disc list-inside space-y-2 text-gray-300 mb-8">
          <li><Link href="/docs/developers/cryptographic-primitives/other-signatures" className="text-orange-400 hover:text-orange-300">Cryptographic Foundations</Link></li>
          <li><Link href="/docs/developers/ergoscript-languages" className="text-orange-400 hover:text-orange-300">ErgoScript Capabilities</Link></li>
        </ul>
      </div>
    </>
  );
