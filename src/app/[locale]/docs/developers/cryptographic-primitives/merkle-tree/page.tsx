          ...
          <div className="space-y-8">
            <section className="bg-neutral-800/50 rounded-xl p-6 border border-neutral-700">
              ...
              <p className="text-gray-300 mb-6">
                <strong>Merkle Trees</strong> are a fundamental <a href="/docs/developers/cryptographic-primitives" className="text-blue-400 hover:text-blue-300 underline">data structure</a> in the Ergo blockchain, ensuring the integrity and authenticity of data. They play a crucial role in various blockchain operations, from verifying <a href="/docs/developers/data-model-apis/composing" className="text-blue-400 hover:text-blue-300 underline">transactions</a> within <a href="/docs/developers/data-model-apis/block-header" className="text-blue-400 hover:text-blue-300 underline">blocks</a> to securing additional metadata in the <a href="/docs/developers/data-model-apis/extension-section" className="text-blue-400 hover:text-blue-300 underline">Extension Block</a>. While similar to the Merkle Tree implementation in Bitcoin—where trees are constructed for block transactions and transaction witnesses (introduced with <a href="https://en.bitcoin.it/wiki/Segregated_Witness" className="text-blue-400 hover:text-blue-300 underline">SegWit</a>)—Ergo extends this concept by combining transactions and their corresponding <a href="/docs/developers/ergoscript-languages/wallet-interaction/signing" className="text-blue-400 hover:text-blue-300 underline">spending proofs</a> into a single Merkle Tree.
              </p>
              <p className="text-gray-300 mb-6">
                The Merkle Tree format in Ergo follows a specific structure and encoding scheme that is essential for developers working with Merkle proofs and validating data inclusion. For detailed information on the Merkle Tree format, leaf nodes, internal nodes, and the process of validating Merkle proofs, refer to the <a href="/docs/developers/cryptographic-primitives/merkle-tree/core" className="text-blue-400 hover:text-blue-300 underline">Merkle Tree Format</a> and <a href="/docs/developers/cryptographic-primitives/merkle-tree/core" className="text-blue-400 hover:text-blue-300 underline">Merkle Tree Validation</a> sections.
              </p>
            </section>
            ...
            <section className="bg-neutral-800/50 rounded-xl p-6 border border-neutral-700">
              ...
              <ul className="text-gray-300 space-y-3">
                ...
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-1">•</span>
                  <div>
                    <strong>Pregenesis State</strong>: Ergo's deterministic pregenesis state, configured at the blockchain's inception, facilitates seamless restoration and verification of state transitions by comparing them with the hashes stored in the <a href="/docs/developers/data-model-apis/block-header" className="text-blue-400 hover:text-blue-300 underline">block header</a>.
                  </div>
                </li>
              </ul>
            </section>
              ...
              <div className="space-y-6">
                <div className="bg-neutral-900/50 rounded-lg p-4">
                  ...
                  <p className="text-gray-300 mb-4">
                    The <a href="/docs/developers/cryptographic-primitives/merkle-tree" className="text-blue-400 hover:text-blue-300 underline">Transaction Merkle Tree</a> is a core component of Ergo, combining all transactions and their corresponding spending proofs into a single Merkle Tree. This structure provides a cryptographic guarantee that the transaction data has not been tampered with, playing a critical role in the <a href="/docs/introduction/autolykos" className="text-blue-400 hover:text-blue-300 underline">Proof-of-Work (PoW)</a> mechanism. The Merkle Root, derived from this tree, is included in the <a href="/docs/developers/data-model-apis/block-header" className="text-blue-400 hover:text-blue-300 underline">block header</a>, ensuring that any change to a transaction within the block results in a different Merkle Root.
                  </p>
                ...
                <div className="bg-neutral-900/50 rounded-lg p-4">
                  ...
                  <p className="text-gray-300 mb-4">
                    The <a href="/docs/developers/cryptographic-primitives/merkle-tree/extension-block" className="text-blue-400 hover:text-blue-300 underline">Extension Block Merkle Tree</a> secures key-value data like <a href="/docs/developers/infrastructure/node/protocol" className="text-blue-400 hover:text-blue-300 underline">miner votes</a> and <a href="/docs/developers/infrastructure/node/protocol" className="text-blue-400 hover:text-blue-300 underline">protocol parameters</a>. It organizes this data into a binary Merkle Tree, with leaf nodes containing key-value pair hashes and non-leaf nodes containing child node hashes. The root hash is included in the block header, cryptographically committing to the <a href="/docs/developers/data-model-apis/extension-section" className="text-blue-400 hover:text-blue-300 underline">Extension Block</a> data. Merkle proofs allow efficient verification of specific key-value pairs without downloading the entire block. This tree ensures data integrity and enables secure storage of auxiliary blockchain information.
                  </p>
                  <div className="bg-neutral-800/50 rounded p-3">
                    <p className="text-sm text-gray-400 mb-1">Code Reference:</p>
                    <p className="text-sm text-gray-300">
                ...
                <div className="bg-neutral-900/50 rounded-lg p-4">
                  ...
                  <p className="text-gray-300 mb-4">
                    Merkle Trees are also used to create compact proofs of state transitions (related to <a href="/docs/developers/data-model-apis/block-adproofs" className="text-blue-400 hover:text-blue-300 underline">AD Proofs</a>). These proofs allow for efficient verification of the blockchain state without requiring a <a href="/docs/developers/infrastructure/node" className="text-blue-400 hover:text-blue-300 underline">full node</a>, which is crucial for <a href="/docs/introduction/light-clients" className="text-blue-400 hover:text-blue-300 underline">lightweight clients</a> to securely participate in the network. An example of how a lite client can check a Merkle-tree-based membership proof is detailed in the <a href="/docs/developers/cryptographic-primitives/merkle-tree/lightweight-proofs" className="text-blue-400 hover:text-blue-300 underline">Lite Client Checking Merkle Proof</a> documentation.
                  </p>
                </div>
              </div>
            </section>
          ...
          <section className="bg-neutral-800/50 rounded-xl p-6 border border-neutral-700">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="bg-neutral-900/50 rounded-lg p-4">
                ...
                <ul className="text-gray-300 space-y-2">
                  <li>• <a href="/docs/developers/cryptographic-primitives/merkle-tree/core" className="text-blue-400 hover:text-blue-300 underline">Merkle Tree Format</a></li>
                  <li>• <a href="/docs/developers/cryptographic-primitives/merkle-tree/core" className="text-blue-400 hover:text-blue-300 underline">Merkle Tree Validation</a></li>
                  ...
                  <li>• <a href="/docs/developers/cryptographic-primitives/merkle-tree/lightweight-proofs" className="text-blue-400 hover:text-blue-300 underline">Lite Client Checking Merkle Proof</a></li>
                </ul>
              </div>
            </div>
          </section>
