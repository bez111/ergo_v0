  ...
  return (
    <>
      ...
      <div className="bg-neutral-900/50 border border-cyan-400/20 rounded-xl p-6 mb-8">
        ...
        <ul className="list-disc pl-6 text-gray-300 mb-2">
          <li>
            Learn more: <Link href="/compare/ergo-vs-cardano" className="text-orange-400 hover:text-orange-300 underline">Ergo vs Cardano</Link>
          </li>
          <li>
            Explore cryptography: <Link href="/docs/introduction/research-whitepapers" className="text-orange-400 hover:text-orange-300 underline">Sigma Protocols</Link>
          </li>
        </ul>
      </div>
    </>
