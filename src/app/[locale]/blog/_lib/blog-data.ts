...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    excerpt: 'Acceptance predicates embed task completion conditions directly in the payment UTxO — enforced on-chain by miners, no escrow, no oracle, no dispute resolution. Here is how they work and how to implement them.',
    date: '2026-03-20',
    lastUpdated: '2026-03-20',
    author: authors['dev-relations']!,
    ...
    wordCount: 2800,
    image: '/og/agent-economy.png',
    tags: ['ErgoScript', 'Acceptance Predicate', 'Agent Economy', 'Smart Contracts', 'Developer'],
    featured: false,
    trending: true,
    difficulty: 'Advanced',
    shares: 0
  },
  {
    ...
    excerpt: 'Ergo has native tokens and Notes (programmable bearer instruments). For simple transfers, tokens work. For agent payment pipelines — conditional, expiring, Reserve-backed — Notes are the right primitive.',
    date: '2026-03-20',
    lastUpdated: '2026-03-20',
    author: authors['dev-relations']!,
    category: 'Development',
    ...
    wordCount: 2400,
    image: '/og/agent-economy.png',
    tags: ['Notes', 'Tokens', 'Bearer Instrument', 'Agent Economy', 'eUTXO'],
    featured: false,
    trending: true,
    difficulty: 'Intermediate',
    shares: 0
  },
  {
    ...
    excerpt: 'Chain-by-chain report card on autonomous agent payment infrastructure. What is working, what is broken, which chain is technically ready, and what builders are actually doing in Q1 2026.',
    date: '2026-03-20',
    lastUpdated: '2026-03-20',
    author: authors['dev-relations']!,
    category: 'Vision',
    ...
    wordCount: 3000,
    image: '/og/agent-economy.png',
    tags: ['Agent Economy', 'State of Ecosystem', 'AI Payments', '2026', 'Chain Comparison'],
    featured: true,
    trending: true,
    difficulty: 'Intermediate',
    shares: 0
  },
  {
    ...
    excerpt: 'Step-by-step tutorial: autonomous agent with Ergo wallet, paid Express API that verifies on-chain payment, complete end-to-end agent payment flow on testnet. Full source code included.',
    date: '2026-03-20',
    lastUpdated: '2026-03-20',
    author: authors['dev-relations']!,
    category: 'Development',
    ...
    wordCount: 3200,
    image: '/og/agent-economy.png',
    tags: ['Tutorial', 'Agent Economy', 'Fleet SDK', 'Developer', 'API Payments'],
    featured: false,
    trending: true,
    difficulty: 'Advanced',
    shares: 0
