...
import { ErgoStorageRentClient } from './ErgoStorageRentClient';
...
const SLUG = 'ergo-storage-rent-preventing-blockchain-bloat-rewarding-miners';
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const title =
    ...
    'Ergo Storage Rent: Fixing Blockchain State Bloat & Rewarding Miners';
  const description =
  ...
  return {
    ...
    openGraph: {
      ...
      description:
        'Infographic showing how storage rent tackles state bloat on Ergo by charging long-inactive UTXOs, keeping the chain lean while providing sustainable miner incentives.',
      images: [
        {
...
export default function ErgoStorageRentPage({ params }: Props) {
  const infographic = infographics.find((item) => item.slug === SLUG);
  ...
  return (
    <>
      ...
      />
      <ErgoStorageRentClient infographic={infographic} />
    </>
  );
}
