...
import { ErgoBlockchainIntroClient } from './ErgoBlockchainIntroClient';
...
const SLUG = 'ergo-blockchain-introduction-fundamentals';
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const title =
    ...
    'Ergo Blockchain: Introduction, eUTXO, Autolykos & Sigma';
  const description =
  ...
  return {
    ...
    openGraph: {
      ...
      description:
        'Infographic overview of Ergo’s fundamentals, including its PoW smart contract platform, eUTXO model, Autolykos consensus, Sigma Protocols, and community-driven mission.',
      images: [
        {
...
export default function ErgoBlockchainIntroPage({ params }: Props) {
  const infographic = infographics.find((item) => item.slug === SLUG);
  ...
  return (
    <>
      ...
      />
      <ErgoBlockchainIntroClient infographic={infographic} />
    </>
  );
}
