...
import { ArrowLeft, Shield, Hexagon, Target, CheckCircle, Cpu, Infinity, Eye, Tag } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-6xl mx-auto">
          ...
          <InfographicHero
            ...
            subtitle="Built for sustainability, privacy and verifiable rules on a fair-launched Proof-of-Work platform."
          />
