...
const BOILERPLATE = {
  ...
  threeParagraph: [
    ...
    "Sage, the agent on ergoblockchain.org, is the first production deployment of this stack. A user asks a question; if the question warrants the deeper model, Sage issues a 402 Payment Required and asks for a Note worth 0.001 ERG; the buyer pays; Sage verifies on chain, runs the upgraded answer, and the Note is redeemed in a real testnet transaction. Every paid query is a public proof — not a marketing claim — that the chain runs the workload it argues for.",
  ],
}
