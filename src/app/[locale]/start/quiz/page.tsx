...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://ergoblockchain.org/start/quiz" },
  openGraph: {
    ...
    images: [{ url: "https://ergoblockchain.org/og/quiz.png", width: 1200, height: 630, alt: "Ergo Quiz" }],
    type: "website",
    locale: "en_US"
  },
  twitter: {
