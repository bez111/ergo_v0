...
- https://github.com/buildonergo/agent-economy-kit — Local developer kernel; run \`npm run provider:onboarding\` to generate the same provider path packet offline before publication, assignment, or signing.
