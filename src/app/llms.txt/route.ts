...
- BuildOnErgo kit commands: \`npm run provider:onboarding\`, \`npm run cli -- job:accept receipt_verification\`, and \`npm run cli -- job:quote receipt_verification\` generate local provider/job packets before any publication, assignment, payout, escrow, or wallet signing.
