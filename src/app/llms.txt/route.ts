...
- Start with /agents, /api/agents, /api/agents/registry, /api/jobs, /build/ergo-connect, /.well-known/ergo-connect.json, /api/agent-economy/discovery, /api/agent-economy/first-receipt, /agent-economy/openapi.v0.json, /api/agent-economy/proofs, the latest Sage receipt bundle, and /api/agent-economy/mainnet-gate.
