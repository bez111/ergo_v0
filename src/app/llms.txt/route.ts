...
- BuildOnErgo kit commands: \`npm run provider:onboarding\`, \`npm run cli -- job:accept receipt_verification\`, \`npm run cli -- job:quote receipt_verification\`, and \`npm run cli -- ergo-connect:react-adapter\` generate local provider/job/wallet-adapter contracts before any publication, assignment, payout, escrow, npm claim, vendor-support claim, or wallet signing.
