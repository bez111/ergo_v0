...
import { generateCanonicalImageSitemap, sitemapHeaders, filterIndexablePages } from '@/lib/sitemap-utils'
...
export async function GET() {
  ...
  const sitemap = generateCanonicalImageSitemap(filterIndexablePages(allPages))
