...
export const devServices: DevService[] = [
  ...
  },
  {
    ...
    summary: "Evidence board for Sage receipts, Accord conformance, MCP health, widget state, and mainnet gate status.",
    href: "/agent-economy/proofs",
    apiHref: "/api/agent-economy/proofs",
    category: "agents",
    state: "live",
    latency: "network",
    icon: ReceiptText,
    machineReadable: true,
    notes: [
      "Human page renders the machine-readable proof API.",
      "Keeps receipt data centralized and links to the canonical Sage receipt API.",
    ],
  },
  {
    id: "agent-discovery",
    title: "Agent Economy Discovery",
    summary: "Well-known JSON map for Agent Hub, Proof API, Sage receipts, MCP, schemas, packages, and verification commands.",
    href: "/.well-known/agent-economy.json",
    apiHref: "/api/agent-economy/discovery",
    category: "agents",
    state: "live",
    latency: "network",
    icon: FileJson2,
  ...
  {
    id: "agent-openapi",
    title: "Agent Economy OpenAPI",
    summary: "OpenAPI contract for discovery, live status, proofs, launch kit, review pack, wallet-agent policy, and Sage receipts.",
    href: "/agent-economy/openapi.v0.json",
    apiHref: "/agent-economy/openapi.v0.json",
    category: "agents",
    state: "live",
    latency: "network",
    icon: Braces,
    machineReadable: true,
    notes: [
      "Designed for API clients, SDK scaffolding, and documentation tooling.",
      "Keeps x-ergo-posture.mainnet_ready=false in the contract.",
    ],
  },
  {
