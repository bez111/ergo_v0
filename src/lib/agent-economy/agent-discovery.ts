...
export const agentEntrypoints = {
  ...
  mcp_tools_page: `${BASE_URL}/agents/mcp`,
  mcp_tools_api: `${BASE_URL}/api/agents/mcp-tools`,
  mcp_tools_schema: `${BASE_URL}/agent-economy/economic-mcp-tools.schema.v0.json`,
  ...
  provider_onboarding_page: `${BASE_URL}/agents/onboarding`,
  provider_onboarding_api: `${BASE_URL}/api/agents/onboarding`,
  provider_onboarding_schema: `${BASE_URL}/agent-economy/provider-onboarding.schema.v0.json`,
...
export const agentCapabilities = [
  ...
  {
    id: "follow_provider_onboarding",
    label: "Follow provider onboarding path",
    capability: "provider_onboarding",
    input: "provider intent",
    output:
    ...
    endpoint: agentEntrypoints.provider_onboarding_api,
    human_url: agentEntrypoints.provider_onboarding_page,
    first_step: true,
  },
  {
  ...
  {
    id: "inspect_economic_mcp_tools",
    label: "Inspect economic MCP tool contracts",
    ...
    status: "tool_manifest_published_runtime_pending",
    endpoint: agentEntrypoints.mcp_tools_api,
    human_url: agentEntrypoints.mcp_tools_page,
    first_step: true,
  },
  {
    id: "list_agent_jobs",
...
export const agentCapabilityManifest = {
  ...
  start_here: {
    ...
    economic_mcp_tools: agentEntrypoints.mcp_tools_api,
    service_publish: agentEntrypoints.service_publish_api,
    provider_onboarding: agentEntrypoints.provider_onboarding_api,
