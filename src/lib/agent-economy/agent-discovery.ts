...
export const agentEntrypoints = {
  ...
  reputation_page: `${BASE_URL}/agents/reputation`,
  reputation_api: `${BASE_URL}/api/agents/reputation`,
  reputation_schema: `${BASE_URL}/agent-economy/agent-reputation.schema.v0.json`,
  service_publish_page: `${BASE_URL}/agents/publish`,
  service_publish_api: `${BASE_URL}/api/agents/publish`,
  service_publish_schema: `${BASE_URL}/agent-economy/agent-service-publish.schema.v0.json`,
  jobs_page: `${BASE_URL}/jobs`,
  jobs_api: `${BASE_URL}/api/jobs`,
  jobs_manifest: `${BASE_URL}/.well-known/ergo-agent-jobs.json`,
  job_accept_page: `${BASE_URL}/jobs/accept`,
  job_accept_api: `${BASE_URL}/api/jobs/accept`,
  job_accept_schema: `${BASE_URL}/agent-economy/agent-job-acceptance.schema.v0.json`,
  job_quote_page: `${BASE_URL}/jobs/quote`,
  job_quote_api: `${BASE_URL}/api/jobs/quote`,
  job_quote_schema: `${BASE_URL}/agent-economy/agent-job-quote.schema.v0.json`,
...
export const agentCapabilities = [
  ...
  {
    id: "validate_service_manifest",
    label: "Validate an agent service manifest",
    capability: "service_publish",
    input: "service manifest JSON",
    output: "accepted_for_operator_review verdict, errors, warnings, and next steps. The endpoint does not publish automatically.",
    status: "operator_review_only",
    endpoint: agentEntrypoints.service_publish_api,
    human_url: agentEntrypoints.service_publish_page,
  },
  {
    id: "query_reputation_graph",
    label: "Query receipt-derived reputation",
    capability: "reputation_graph",
    input: "none",
    output:
    ...
    endpoint: agentEntrypoints.reputation_api,
    human_url: agentEntrypoints.reputation_page,
    first_step: true,
  },
  {
    id: "list_agent_jobs",
  ...
  {
    id: "validate_job_acceptance",
    label: "Validate an agent job acceptance intent",
    capability: "job_acceptance",
    input: "job acceptance intent JSON",
    output:
    ...
    status: "operator_review_only",
    endpoint: agentEntrypoints.job_accept_api,
    human_url: agentEntrypoints.job_accept_page,
  },
  {
    id: "scaffold_job_quote",
    label: "Scaffold an agent job quote",
    capability: "job_quote",
    input: "job quote request JSON",
    output:
    ...
    endpoint: agentEntrypoints.job_quote_api,
    human_url: agentEntrypoints.job_quote_page,
  },
  {
...
export const agentCapabilityManifest = {
  ...
  start_here: {
    ...
    reputation_graph: agentEntrypoints.reputation_api,
    service_publish: agentEntrypoints.service_publish_api,
    jobs: agentEntrypoints.jobs_api,
    job_acceptance: agentEntrypoints.job_accept_api,
    job_quote: agentEntrypoints.job_quote_api,
