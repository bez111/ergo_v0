export const agentEconomyDeveloperLaunchKit = {
  ...
  entrypoints: {
    ...
    economic_mcp_tools: "https://www.ergoblockchain.org/agents/mcp",
    economic_mcp_tools_api: "https://www.ergoblockchain.org/api/agents/mcp-tools",
    economic_mcp_tools_schema: "https://www.ergoblockchain.org/agent-economy/economic-mcp-tools.schema.v0.json",
  ...
  api_recipes: [
    ...
    },
    {
      ...
      label: "Economic MCP tool contracts",
      method: "GET",
      url: "https://www.ergoblockchain.org/api/agents/mcp-tools",
      curl: "curl -sS https://www.ergoblockchain.org/api/agents/mcp-tools",
      checks: ["type", "runtime_boundary.mcp_tools_sign_transactions", "tools", "forbidden_assumptions"],
    },
    {
  ...
  builder_kit: {
    ...
    package: "@buildonergo/agent-economy-kit",
    status: "github_developer_kernel",
    install: "git clone https://github.com/buildonergo/agent-economy-kit.git",
    commands: [
      "npm run check",
      ...
      "npm run cli -- job:accept receipt_verification",
      "npm run cli -- job:quote receipt_verification",
      "npm run cli -- ergo-connect:react-adapter",
    ...
    surfaces: [
      ...
      "future ErgoConnect React adapter contract without npm or vendor-support claims",
