...
export const ergoConnectBoundary = {
  ...
  developer_package_skeleton: {
    status: "local_reference_skeleton_not_npm_package",
    repo: "https://github.com/buildonergo/agent-economy-kit",
    path: "packages/connect-ergo-react",
    package_name: "@ergoblockchain/connect-ergo-react",
    version: "0.0.0-reference",
    private: true,
    npm_published: false,
    command: "npm run cli -- ergo-connect:react-package",
    exports: [
      "useErgoConnection",
      "useErgoAuth",
      "useErgoPaySign",
  ...
  recommended_agent_path: [
    ...
    "Use the local BuildOnErgo package skeleton only as a reference contract until a reviewed implementation exists.",
