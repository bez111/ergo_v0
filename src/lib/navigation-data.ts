export const mainNavItems = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        href: "/start/faq",
        description: "Clear answers to the most common questions newcomers have about using Ergo.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        description: "Verified mining pools and essential tools for ERG miners.",
      },
      {
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        href: "/learn/research",
        description: "Academic research papers, whitepapers, and foundational studies on Ergo technology.",
      },
      {
        title: "User & Developer Guides",
        href: "/learn/guides",
        description: "All user and developer how-tos for wallets, nodes, dApps, and APIs in one place.",
      },
      {
        title: "FAQ",
        href: "/learn/faq",
        description: "Answers to frequently asked questions and common troubleshooting steps.",
      },
    ],
  },
]
